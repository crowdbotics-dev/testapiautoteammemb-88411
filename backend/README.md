...
## Project Structure
    ...
    ├── testapiautoteammemb_88411  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_88411`
...
2. Clone this repo and `cd testapiautoteammemb_88411`
